...
/*	function checkAnswer(ans){
	...
	function getAnswers(){
		...
		$.ajax({async: false, url: "http://localhost:8080/", data: {id: 10, currentQuestionIndex: currentQuestionIndex, answer: answer}}).done(function(msg){
			console.log(msg);
		...
		// We need checkAnswer to change the value of a var to a boolean, then below we will check the value of that var
			...
			if(correct){
				...
				// answer is incorrect
				feedBackDiv = $("<div class = 'feedback'>NO YOU'RE WRONG</div>");
